...
if ($dataTrabajador = $trabajador->readAll()) {
    ...
    $pdf->startReport('Trabajadores de FEASVERSE', 'Reporte sobre todos los trabajadores de nuestra tienda', '', 43, 40);
    ...
    foreach ($dataTrabajador as $rowTrabajador) {
        $pdf->cell(10);
        ($rowTrabajador['estado_trabajador']) ? $estado = 'Activo' : $estado = 'Desactivo';
        // Se imprimen las celdas con los datos de los productos.
        $pdf->cell(100, 10, $pdf->encodeString($rowTrabajador['nombre_trabajador']), 0, 0);
