...
if ($dataOrders = $Pedidos->searchOrders('Entregado', '')) {
    // Se inicia el reporte con el encabezado del documento.
    $pdf->startReport('Reporte FEASVERSE de todos los pedidos entregado: ', 'Reporte sobre todos pedidos entregado', '', 100, 10);
